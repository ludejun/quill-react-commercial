...
class UINode extends module$1.default {
  isListening = false;
  ...
  handleArrowKeys() {
    this.quill.keyboard.addBinding({
      ...
      handler(range, _ref) {
        ...
        if (!(line instanceof parchment.ParentBlot) || !line.uiNode) {
          return true;
        }
        ...
        this.quill.setSelection(range.index - 1, range.length + (event.shiftKey ? 1 : 0), quill.default.sources.USER);
        return false;
      }
    });
  }
  ...
  handleSelectionChange() {
    ...
    if (!(line instanceof parchment.ParentBlot) || !line.uiNode) return;
...
exports.TTL_FOR_VALID_SELECTION_CHANGE = TTL_FOR_VALID_SELECTION_CHANGE;
