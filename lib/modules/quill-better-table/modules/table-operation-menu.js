...
var insertColumnRight = require('../../../assets/icons/insertColumnRight.svg.js');
var insertColumnLeft = require('../../../assets/icons/insertColumnLeft.svg.js');
var insertRowAbove = require('../../../assets/icons/insertRowAbove.svg.js');
var insertRowBelow = require('../../../assets/icons/insertRowBelow.svg.js');
var mergeCells = require('../../../assets/icons/mergeCells.svg.js');
var splitCells = require('../../../assets/icons/splitCells.svg.js');
var deleteColumn = require('../../../assets/icons/deleteColumn.svg.js');
var deleteRow = require('../../../assets/icons/deleteRow.svg.js');
var _delete = require('../../../assets/icons/delete.svg.js');
...
const MENU_ITEMS_DEFAULT = {
  insertColumnRight: {
    ...
    iconSrc: insertColumnRight.default,
    handler() {
      ...
      this.quill.setSelection(this.quill.getIndex(newColumn[0]), 0, quill.default.sources.SILENT);
  ...
  insertColumnLeft: {
    ...
    iconSrc: insertColumnLeft.default,
    handler() {
      const tableContainer = quill.default.find(this.table);
      let colIndex = getColToolCellIndexByBoundary(
        this.columnToolCells,
  ...
  insertRowUp: {
    ...
    iconSrc: insertRowAbove.default,
    handler() {
      const tableContainer = quill.default.find(this.table);
      ...
      this.quill.update(quill.default.sources.USER);
      this.quill.setSelection(this.quill.getIndex(affectedCells[0]), 0, quill.default.sources.SILENT);
      this.tableSelection.setSelection(
  ...
  insertRowDown: {
    ...
    iconSrc: insertRowBelow.default,
    handler() {
      const tableContainer = quill.default.find(this.table);
      const affectedCells = tableContainer.insertRow(
        this.boundary,
  ...
  mergeCells: {
    ...
    handler() {
      ...
      const colspan = this.columnToolCells.reduce((sum, cell) => {
        let cellRect = index.getRelativeRect(cell.getBoundingClientRect(), this.quill.root.parentNode);
        if (
...
function getColToolCellIndexByBoundary (cells, boundary, conditionFn, container) {
  return cells.reduce((findIndex, cell) => {
    let cellRect = index.getRelativeRect(cell.getBoundingClientRect(), container);
...
function getColToolCellIndexesByBoundary (cells, boundary, conditionFn, container) {
  return cells.reduce((findIndexes, cell) => {
    let cellRect = index.getRelativeRect(
