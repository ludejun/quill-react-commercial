...
var icon_operation_1 = require('../../../assets/icons/icon_operation_1.svg.js');
var icon_operation_2 = require('../../../assets/icons/icon_operation_2.svg.js');
var icon_operation_3 = require('../../../assets/icons/icon_operation_3.svg.js');
var icon_operation_4 = require('../../../assets/icons/icon_operation_4.svg.js');
var icon_operation_5 = require('../../../assets/icons/icon_operation_5.svg.js');
var icon_operation_6 = require('../../../assets/icons/icon_operation_6.svg.js');
var icon_operation_7 = require('../../../assets/icons/icon_operation_7.svg.js');
var icon_operation_8 = require('../../../assets/icons/icon_operation_8.svg.js');
var icon_operation_9 = require('../../../assets/icons/icon_operation_9.svg.js');
...
const MENU_ITEMS_DEFAULT = {
  insertColumnRight: {
    ...
    iconSrc: icon_operation_1.default,
    handler () {
  ...
  insertColumnLeft: {
    ...
    iconSrc: icon_operation_2.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
      let colIndex = getColToolCellIndexByBoundary(
        this.columnToolCells,
  ...
  insertRowUp: {
    text: 'Insert row up',
    iconSrc: icon_operation_3.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
  ...
  insertRowDown: {
    ...
    iconSrc: icon_operation_4.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
      const affectedCells = tableContainer.insertRow(
        this.boundary,
  ...
  mergeCells: {
    ...
    iconSrc: icon_operation_5.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
  ...
  unmergeCells: {
    text: 'Unmerge cells',
    iconSrc: icon_operation_6.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
  ...
  deleteColumn: {
    ...
    iconSrc: icon_operation_7.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
  ...
  deleteRow: {
    ...
    iconSrc: icon_operation_8.default,
    handler () {
      const tableContainer = quill.default.find(this.table);
  ...
  deleteTable: {
    text: 'Delete table',
    iconSrc: icon_operation_9.default,
    handler () {
