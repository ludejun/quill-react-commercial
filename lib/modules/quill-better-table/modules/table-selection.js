...
class TableSelection {
  ...
  mouseDownHandler (e) {
    ...
    const startTdRect = index.getRelativeRect(
    ...
    function mouseMoveHandler (e) {
      ...
      const endTdRect = index.getRelativeRect(
  ...
  correctBoundary () {
    ...
    tableCells.forEach(tableCell => {
      let { x, y, width, height } = index.getRelativeRect(
  ...
  refreshHelpLinesPosition () {
    const startRect = index.getRelativeRect(
  ...
  clearSelection () {
    ...
    this.selectedTds = [];
    LINE_POSITIONS.forEach(direction => {
      this[direction] && index.css(this[direction], {
        display: 'none'
      });
    });
  }
