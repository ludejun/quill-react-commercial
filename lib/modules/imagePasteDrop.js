    ...
    uploadBase64Img(img) {
      ...
      `;
            ...
            this.b64ToUrl(base64Str)
                ...
                const rect = img.getBoundingClientRect();
                statusDiv.style.cssText = `${statusDiv.style.cssText}left:${rect.left - containerRect.left - 1 + parent.scrollLeft}px;top:${rect.top - containerRect.top + parent.scrollTop}px;height:${img.height}px;width:${img.width}px;`;
