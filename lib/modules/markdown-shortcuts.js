...
quill.default.register('formats/horizontal', HorizontalRule);
      ...
      },
      {
        ...
        action: (text, selection) => {
          ...
          setTimeout(() => {
            ...
            this.quill.insertEmbed(startIndex + 1, 'hr', true, quill.default.sources.USER);
            this.quill.insertText(startIndex + 2, '\n', quill.default.sources.SILENT);
            this.quill.setSelection(startIndex + 2, quill.default.sources.SILENT);
          }, 0);
        },
      },
      {
