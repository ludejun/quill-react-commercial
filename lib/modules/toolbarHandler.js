...
import { isUrl, isEmail } from '../utils.js';
import close from '../assets/icons/icon_close.svg.js';

function imageUpload(quill, imgUploadApi, uploadSuccCB, uploadFailCB) {
  quill.disable();
...
export { imageUpload, linkHandler, redoHandler, undoHandler, uploadImg };
