...
export function saveLink(quill, isToolbar) {
    if (isToolbar) {
        const range = quill.getSelection();
        quill.deleteText(range.index, range.length);
        quill.insertText(range.index, document.getElementById('link-words').value, 'link', document.getElementById('link-url').value, 'user');
    }
...
export const optionDisableToggle = (quill, blockList, disable) => {
